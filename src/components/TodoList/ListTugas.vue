    ...
    <v-main class="list">
        ...
        <v-card>
            ...
            <v-data-table :headers="headers" :items="todos" :search="search">
                <template v-slot:[`item.priority`]="{ item }">
                    <td>
                        <v-card v-if="item.priority == 'Penting'" style="border-color: red; color: red; width: fit-content; padding: 2px 7px 2px 7px;" outlined>
                            {{ item.priority }}
                        </v-card>
                        <v-card v-else-if="item.priority == 'Biasa'" style="border-color: darkblue; color: darkblue; width: fit-content; padding: 2px 7px 2px 7px;" outlined>
                            {{ item.priority }}
                        </v-card>
                        <v-card v-else outlined style="border-color: green; color: green; width: fit-content; padding: 2px 7px 2px 7px;">
                            {{ item.priority }}
                        </v-card>
                    </td>
                </template>
        ...
        <v-dialog v-model="dialognote" persistent max-width="400px">
            <v-card>
                ...
                <v-card-text>
                    <v-container>
                        <v-card v-if="detail.priority == 'Penting'" style="border-color: red; color: red; width: fit-content; padding: 2px 7px 2px 7px;" outlined>
                            {{detail.priority}}
                        </v-card>
                        <v-card v-else-if="detail.priority == 'Biasa'" style="border-color: darkblue; color: darkblue; width: fit-content; padding: 2px 7px 2px 7px;" outlined>
                            {{detail.priority}}
                        </v-card>
                        <v-card v-else outlined style="border-color: green; color: green; width: fit-content; padding: 2px 7px 2px 7px;">
                            {{detail.priority}}
...
<style scoped>
    .icnote{color: purple !important;}
    .pencil{color: darkblue !important;}
